...
import AutonomousInput from '../../models/AutonomousInput';


const SigninAutonomousScreen = props => {
    ...
    const submitHandler = () =>{
        if(neighborhood === '' || name === '' || num === '' || street === '' || countries == [] || states == [] || cities ==[] || segs === []|| desc === ''){
            ...
            const filledForm = new AutonomousInput(countries, states, cities, segs, name, neighborhood, street, num, desc);
        
            fetch('https://my-test-help-app.firebaseio.com/registers/autonomous.json',{
                    method: 'POST',
                    headers: {
        ...
        <View style = {styles.screen}>
            ...
            <KeyboardAwareScrollView keyboardShouldPersistTaps = 'handled' style = {styles.scroll}>
                <View style = {styles.formContainer}>
                    ...
                    <Text style = {styles.label}>Describe your autonomous enterprise:</Text>
...
SigninAutonomousScreen.navigationOptions = navData => {
    return{
        headerTitle: 'Register Autonomous Enterprise',
    };
};
...
export default SigninAutonomousScreen;